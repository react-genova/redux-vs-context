...
// action creators
export const editPlayerName = name => ({
    type: EDIT_PLAYER_NAME,
    payload: { name }
});
export const editPlayerSurname = surname => ({
...
const reducers = {
    ...
    [EDIT_PLAYER_SURNAME]: (state, { payload: { surname } }) => ({
        ...state,
        surname
    })
};
const identity = state => state;
const player = (state = { name: '', surname: '' }, action = {}) =>
    (reducers[action.type] || identity)(state, action);
